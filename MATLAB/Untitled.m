...
clc
%filename = 'C:\Users\Gandhi Lab.DESKTOP-IQP0LND\Documents\VR_TimeBased\test_gain9_session1_VR_TimeBased_2019-05-10_1956.csv'
% data = xlsread(filename);
% XYdata = [data(:,3),data(:,8:12)];
...
%      hold on
%  end
%   title(sprintf('trial %i, Camera Angle Over Time',trials))
%     xlabel('time (sec)')
%     ylabel('rotation (deg)')
%      yticks([-50:10:50])
